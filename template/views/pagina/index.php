...
<body>
    ...
    <section class="galeria" id="galeria">
        <div class="galeria_top">
            ...
            <div class="box_galery">
                <img class="lightbox" data-caption_light="atardacer chimborazo" src="<?php echo IMAGES.'web/'; ?>chimborazo.jpg"
                    alt="atardacer chimborazo">
            </div>
            <div class="box_galery">
